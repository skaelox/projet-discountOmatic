...
<b><h1 class="text-center text-dark">Inscription</h1></b>
...
<form:form action="/signin" method="post" modelAttribute="createaccountform">
    <div id="container">
        ...
        <!-- Adresse -->    
        <h2 class="text-center text-dark">Adresse</h2>
        ...
        <!-- Button -->
        <input class="btn btn-success w-25 mx-auto" type="submit" id='submit' value='Valider'>
        <input class="btn btn-danger w-25 mx-auto " type="submit" id='submit' value='Annuler'>
    </div>
</form:form>
